...
const HomePage = () => {
  ...
  const {isPending, data: products} = useQuery({
    ...
    retryDelay: 1000,      // thời gian chờ giữa các lần retry (ms)
    keepPreviousData: true // isPreviousData: giữ lại các data cũ, khi click chỉ load các data mới
  })
        ...
        <div style={{width: '100%',display: 'flex' , justifyContent: 'center', marginTop: '10px'}}>
          <WrapperButtonMore 
            ...
            styleButton={{
              ...
              color:`${(products?.total === products?.data?.length || products?.totalPage === 1) ? '#ccc' : 'rgb(11, 116, 229)'}`,
              // backgroundColor: '#fff',
              width: '240px',
              height: '38px',
              borderRadius: '4px',
